    ...
    get Template() {
        return `
            <a class="btn btn-transparent m-2 text-light" data-bs-toggle="collapse" href="#contentId" aria-expanded="false" aria-controls="contentId" style="text-align:right">
                <h5><img src="${this.icon}"> ${this.name} ${this.temp}° F</h5>
            </a>
            <div class="collapse p-2 text-light" id="contentId">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" onChange="app.weatherController.toggleTemp(this)" type="checkbox" id="flexSwitchCheckDefault" />
                    <label>
                        Display in Celcius
                    </label>
                </div>
